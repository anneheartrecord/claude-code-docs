...
这套设计背后有一个更大的行业趋势：**AI Agent 正在从"对话式"走向"操作式"**。2023 年的 ChatGPT 只能生成文字，2024 年的 Agent 开始调用工具，2025 年的 Claude Code 已经能独立完成从读需求到写代码到跑测试的完整流程。工具系统的设计质量，直接决定了一个 Agent 的实际生产力。
